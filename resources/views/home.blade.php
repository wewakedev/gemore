    ...
    <header class="hero-section custom-hero">
        <div class="container hero-flex">
            ...
            <div class="hero-center">
                <img src="{{ asset('images/product_fruit-removebg-preview.png') }}"
                    alt="Ge More Nutralife Premium Pre-Workout Supplement - Fruit Punch Flavor" class="hero-product-img"
                                ...
                                @if ($product->activeVariants->count() > 0)
                                    <div class="product-variants">
                                        ...
                                        @if ($product->activeVariants->count() > 2)
                                            <span class="variant-more">+{{ $product->activeVariants->count() - 2 }}
                                                more</span>
                                        @endif
                                    </div>
                                    ...
                                    <div class="product-price">
                                        @php
                                            $defaultVariant = $product->activeVariants
                                        ...
                                        @if ($defaultVariant && $defaultVariant->original_price && $defaultVariant->original_price > $defaultVariant->price)
                                            <span
                                                class="original-price">₹{{ number_format($defaultVariant->original_price) }}</span>
    ...
    <section id="about" class="py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="{{ asset('images/aboutgemore.jpg') }}"
                        alt="Ge More Nutralife - GMP and FSSAI certified sports supplements manufacturer with premium quality assurance"
                        class="img-fluid rounded shadow" width="600" height="400" loading="lazy" />
                </div>
                <div class="col-md-6">
                    <h2>About Ge More Nutralife</h2>
                    <p>We are committed to providing premium quality sports supplements that help you achieve your fitness
                        goals. Our products are GMP & FSSAI certified, ensuring the highest standards of quality and safety.
                    </p>
                ...
                <div class="col-lg-7">
                    <div class="contact-form-container">
                        ...
                        <form id="contactForm" method="POST" action="/api/contact">
                            ...
                            <button type="submit" class="btn btn-primary btn-contact-primary">
        ...
        document.getElementById('contactForm').addEventListener('submit', function(e) {
            ...
            fetch('/api/contact', {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        messagesDiv.innerHTML = '<div class="alert alert-success">' + (data.message ||
                            'Message sent successfully!') + '</div>';
                        this.reset();
                    } else {
                        messagesDiv.innerHTML = '<div class="alert alert-danger">' + (data.error ||
