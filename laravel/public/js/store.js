    ...
    loadProducts() {
        this.products = [
            ...
            },
            {
                ...
                description:
                    "Energy boost supplement for enhanced workout performance",
                price: 1299,
                originalPrice: 1599,
            ...
            },
            {
                ...
                description:
                    "Premium creatine monohydrate for strength and power",
                price: 899,
                originalPrice: 1199,
    ...
    addToCartButtons.forEach((button) => {
        button.addEventListener("click", function () {
            ...
            const product = {
                ...
                variant:
                    productCard.querySelector(".variant-option input:checked")
                        ?.value || "default",
                price: parseInt(
                    productCard
